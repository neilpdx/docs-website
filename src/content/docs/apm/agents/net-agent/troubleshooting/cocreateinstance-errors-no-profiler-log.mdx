...
<CollapserGroup>
  ...
  >
    ...
    1. Check your application event log for errors like this:
       ...
       ```
       NET Runtime version 4.0.30319.296 - Loading profiler failed during CoCreateInstance. Profiler CLSID: '71DA0A04-7777-4EC6-9643-7D28B46A8A4'
       ```
    2. Compare the CLSID in the error to New Relic's CLSID:
